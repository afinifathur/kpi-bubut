...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white p-5 rounded-2xl shadow-sm border border-slate-100">
            ...
            <div class="mt-3 flex items-center gap-1 text-xs {{ $gap >= 0 ? 'text-emerald-500' : 'text-red-500' }} font-bold">
        ...
        <div class="bg-white p-5 rounded-2xl shadow-sm border border-slate-100">
            ...
            <div class="mt-3 flex items-center gap-1 text-xs {{ $efficiency >= 100 ? 'text-emerald-500' : 'text-orange-500' }} font-bold">
        ...
        <div class="bg-white p-5 rounded-2xl shadow-sm border border-slate-100">
            ...
            <div class="mt-3 flex items-center gap-1 text-xs {{ $overallKpi >= 90 ? 'text-teal-600' : 'text-orange-500' }} font-bold">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                ...
                <p class="text-xs text-gray-400 text-center mt-2 italic">* Data breakdown per line belum tersedia</p>
            </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-full {{ $index == 0 ? 'bg-amber-400' : 'bg-slate-400' }} flex items-center justify-center text-white font-bold text-xs shadow-sm">
                                {{ $index + 1 }}
                            </div>
                            <div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Line Production Chart (Placeholder for now)
