...
@section('content')
    ...
    <div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('export.operator', request()->query()) }}" class="inline-flex items-center justify-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
