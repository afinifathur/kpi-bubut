...
Route::middleware('auth')->group(function () {
    ...
    */
    Route::prefix('hr-report')->name('hr_report.')->group(function () {
        ...
        Route::post('/{id}/submit', [\App\Http\Controllers\HrReportController::class, 'submitForApproval'])->name('submit');
    ...
    */
    Route::prefix('api')->name('api.')->group(function () {
        ...
        Route::get('/resolve/ktr', [\App\Http\Controllers\AutocompleteController::class, 'resolveKtr'])->name('resolve.ktr');
